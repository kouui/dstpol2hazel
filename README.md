...
##  - 'Boundary condition' : background incident stokes vector (in line-of-sight), (1,0,0,0) on disk (affected by center-to-limb variation) and (0,0,0,0) off limb. (refer to hazel documentation for details) 
nwave = 150
